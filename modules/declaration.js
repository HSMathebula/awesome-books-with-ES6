...
export const ctaList = document.getElementById('listBtn');
export const ctaAdd = document.getElementById('addBtn');
export const ctaContact = document.getElementById('contact');